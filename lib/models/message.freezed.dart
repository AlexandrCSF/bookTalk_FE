...
abstract class $MessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int conversation, int author, String text});
}
...
class _$MessageImpl implements _Message {
  ...
  @override
  String toString() {
    return 'Message(id: $id, conversation: $conversation, author: $author, text: $text)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, conversation, author, text);
