          ...
          child: Align(
            ...
            child: Column(
              children: [
                ...
                const TextFieldWidget(label: "Имя и фамилия", hintText: "Введите имя и фамилию", maxLines: 1),
                const TextFieldWidget(label: "Город",hintText: "Введите ваш город", maxLines: 1),
                const TextFieldWidget(label: "Почта", hintText: "Введите почту", maxLines: 1),
                Column(
                  children: [
                    Padding(
